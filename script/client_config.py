...
def get_client_config_info():
    return 'pty "pptp smrtyan.cn --nolaunchpppd" name culiu remotename PPTP require-mppe-128 file /etc/ppp/options.pptp ipparam culiu'
...
if device_IMEI == "867698045127654":
    ...
    secrets_file.write("culiu	PPTP	culiu	172.16.0.102")
    secrets_file.close()
